                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <h3  class=" text-gray-900 dark:text-white">Walcome to Wallet </h3>
                                </div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-md">
                                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorum esse quod quam, magni dicta quaerat hic sed veniam maiores at. Eum nam alias nemo adipisci saepe nostrum, impedit quis ullam.
                                </div>
                            </div>
                        </div>
